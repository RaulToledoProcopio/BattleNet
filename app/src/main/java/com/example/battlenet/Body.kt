...
fun Body(modifier: Modifier, loginViewModel: LoginViewModel) {
    ...
    val loginResult: Boolean? by loginViewModel.loginResult.observeAsState()
    ...
    Column(modifier = modifier) {
        ...
        Email(modifier.align(Alignment.CenterHorizontally), email) { loginViewModel.onEmailChanged(it) }
        Spacer(modifier = Modifier.size(16.dp))
        ...
        Column(
            ...
            Row(
                ...
                Image(
                    ...
                    modifier = Modifier
                        .size(48.dp)
                        // Hacemos que nos lleve a una url al clickarlos con la implementación de Intent y Uri
                        .clickable {
                            val intent = Intent(
                                Intent.ACTION_VIEW,
                ...
                Image(
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            val intent =
                                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.apple.com"))
                            context.startActivity(intent)
                        }
                )
            }
            ...
            Row(
                ...
                Image(
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            val intent =
                                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.xbox.com"))
                            context.startActivity(intent)
                        }
                )
                Spacer(modifier = Modifier.width(25.dp))
                Image(
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            val intent =
                                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.playstation.com"))
                            context.startActivity(intent)
                        }
                )
                Spacer(modifier = Modifier.width(25.dp))
                Image(
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            val intent =
                                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.nintendo.com"))
                            context.startActivity(intent)
                        }
                )
                Spacer(modifier = Modifier.width(25.dp))
                Image(
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            val intent = Intent(
                                Intent.ACTION_VIEW,
                                Uri.parse("https://store.steampowered.com")
                            )
                            context.startActivity(intent)
                        }
                )
